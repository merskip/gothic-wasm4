    ...
    instrument_data: &[
        ...
        ClipInstrumentData {
            ...
            sound_list: &[
                ...
                Sound { beat: 2, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 3, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 4, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 6, octave: Octave::OCT_2, note: Note::d_s(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 8, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 9, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 10, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },
                Sound { beat: 12, octave: Octave::OCT_2, note: Note::c(NoteLength::EIGHT), volume: 75 },

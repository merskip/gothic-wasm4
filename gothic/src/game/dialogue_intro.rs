...
pub const DIALOGUE_INTRO: Dialogue = Dialogue {
    sentences: &[
        ...
        sentence!(FIRE_MAGE_ACTOR: "Sam bedziesz mogl wybrac sobie nagrodę. Magowie dadza Ci wszystko czego zazadasz"),
        sentence!(PLAYER_ACTOR: "Niech bedzie, zaniosę wasz cenny list. Pod jednym warunkiem. Oszczedzcie mi reszty tej paplaniny."),
